...
const (
	...
	INSERT_TRANSACTION = `INSERT INTO transactions (id, user_id, transaction_type, amount, receiver_id, category_id, transaction_date) 
	...
	//USERS
	SELECT_USER_BYID = "SELECT name, email, phonenumber, password, address, birth_date FROM users WHERE id=$1"
	SELECT_ALL_USER  = "SELECT name, email, phonenumber, password, address, birth_date FROM users"
	INSERT_NEW_USER  = "INSERT INTO users (name, email, phonenumber, password, address, birth_date) VALUES ($1, $2, $3, $4, $5, $6)"
	UPDATE_USER_BYID = "UPDATE users SET name=$1, email=$2, phonenumber=$3, password=$4, address=$5, birth_date=$6"
